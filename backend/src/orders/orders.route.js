...
router.post("/create-checkout-session", async (req,res) => {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        mode: 'payment' ,
        success_url: `https://style-ecom-frontend.vercel.app/success?session_id={CHECKOUT_SESSION_ID}`,
        cancel_url: `https://style-ecom-frontend.vercel.app/cancel`,
    })
...
router.post("/confirm-payment", async (req, res) => {
  ...
  try {
    //  Retrieve the Stripe session using the session_id sent from frontend
